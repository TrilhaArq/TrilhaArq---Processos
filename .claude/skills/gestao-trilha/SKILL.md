...
- **Cópia de teste (dados fictícios, sem Google Agenda):** https://claude.ai/artifact/V9bUhPfLyowX83XUz5Zeaw —
  módulos novos são testados lá antes de ir para o link oficial (o Financeiro v1 já está no oficial).
...
2. **Capa** = só botões, sem avisos nem dados dos apps do escritório (cada app é "um app dentro do app", com a
   própria página inicial e os próprios avisos; dentro dele o topo tem só "← Início", sem abas de outros apps):
   botões das pessoas (área "pessoa": Tempo, Tarefas) e botões do Escritório
